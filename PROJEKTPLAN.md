...
- ⏳ DEPLOY 1.5.3 (fix 3+4): Mac ✅ deployad+verifierad (CPU 0,0%). iPhone-install BLOCKERAD av DDI ("No provider was found" — Developer Disk Image ej monterad, devicectl når ej enheten; 1.5.2 ligger kvar orörd). KVAR: lås upp iPhonen → retry install → tagg v1.5.3 + ZIP. 47 unit + arch + conformance/render 3/3 gröna.
