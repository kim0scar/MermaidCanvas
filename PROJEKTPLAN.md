...
NU: MB — ✅ Steg G KLAR (G1 Extended-format-spec + G2 basfigur-polish), ✅ Steg H (export-bild + render-grind 💡#8). NÄST: deploy v81 (export live på iPhone) → steg 8 del 2 (container-note + skill-korpus + fil-glyf) → steg 9 (UI-mall). EFTER: steg 0 (städa rot), 1–5 (UX-111–114). ✅ Steg F, 6, 7, 8 del 1. n8n + M4 PAUSADE. MA + M3 klara.
[grundappen MB: ██████░░░░] G+H klara · 💡 Idébanken: 8 fångade, 3 byggda
