...
NU: ⏳ GOVERNANCE-RESET (Kims order 2026-06-28) — appen glidit förbi PRODUKT.md-scope + underflöden byggt utan regel-13-spår. Riktar upp: scope-realign (PRODUKT.md), underflöden PARKERAS → ROADMAP (återupptas bara via native subgraphs), täta regel-motsägelser (3b↔15a, EXTENDED↔AppCapabilities), bocka idébank, städa stale docs. SEDAN: v1.5-fixarna (skrivflöde + röj skräp + samma meny + autocorrect + anteckningar elegant — Kims fynd kartlagda via se-appen). DEPLOYAD v1.5 ligger på iPhone. n8n + M4 PAUSADE.
