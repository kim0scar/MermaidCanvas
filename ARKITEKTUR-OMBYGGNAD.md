...
- **Steg 7–11 — ToolbarView** (1069). Raderna är `private var ...Secondary: some View` → gör var och en till egen `struct ...Row: View` i `Views/Toolbar/`: ShapesRow, ColorsRow, TextStylesRow, PacksRow, MultiSelectRow. Callbacks blir init-parametrar; ToolbarView blir tunn dispatcher.
