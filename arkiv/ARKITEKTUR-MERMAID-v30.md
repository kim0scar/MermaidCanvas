# ARKITEKTUR-MERMAID — Version v30
*Datum: 2026-05-17*

> **Status:** v30 är efter en intensiv fix-cykel v28→v29→v30. Huvudfix i v30: chip.link kunde dras men inte tap:as på iPhone pga ScrollView i Former-raden konsumerade tap-events. Återgick till plain HStack. Tidigare fix v29: drag-out-determinism (canvas-pan stängs av under drag, controller-state sync), resize-handtag-ikoner, form-paketer kopplade till Former-raden, round-trip-unit-test för alla 6 form-typer. v30 ska efter iPhone-XCUITest verifiera 17 tester gröna inkl 3 unit-tests.
