...
struct ToolbarView: View {
    ...
    private enum ColorTarget: String, CaseIterable {
        case pack = "Paket"
        case fill = "Fyllning"
        case stroke = "Ram"
    }
    @State private var colorTarget: ColorTarget = .pack
    ...
    @ViewBuilder
    private var clearSwatchChip: some View {
        Button {
            applySwatch(nil)
        } label: {
            ZStack {
    ...
    @ViewBuilder
    private func swatchChip(_ hex: String) -> some View {
